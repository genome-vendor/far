...
// _align_needleman_wunsch_quality

template <typename TTrace, typename TStringSet, typename TScore, typename TValPair, typename TIndexPair, typename TAlignConfig> inline typename Value<TScore>::Type _align_needleman_wunsch_quality(TTrace & trace, TStringSet const & str, TScore const & _sc, TValPair & overallMaxValue, TIndexPair & overallMaxIndex, TAlignConfig const);       	// "projects/library/seqan/graph_align/graph_align_needleman_wunsch.h"(120)

//____________________________________________________________________________
// _align_needleman_wunsch_quality_trace

template <typename TAlign, typename TStringSet, typename TTrace, typename TIndexPair> void _align_needleman_wunsch_quality_trace(TAlign& align, TStringSet const& str, TTrace const& trace, TIndexPair const& overallMaxIndex);       	// "projects/library/seqan/graph_align/graph_align_needleman_wunsch.h"(39)
...
template <typename TAlign, typename TStringSet, typename TScore, typename TAlignConfig> inline typename Value<TScore>::Type _globalAlignment(TAlign& align, TStringSet const& str, TScore const& sc, TAlignConfig const, NeedlemanWunschQuality);       	// "projects/library/seqan/graph_align/graph_align_needleman_wunsch_quality.h"(216)
template <typename TStringSet, typename TScore, typename TAlignConfig> inline typename Value<TScore>::Type _globalAlignment(TStringSet const& str, TScore const& sc, TAlignConfig const, NeedlemanWunschQuality);       	// "projects/library/seqan/graph_align/graph_align_needleman_wunsch_quality.h"(241)
